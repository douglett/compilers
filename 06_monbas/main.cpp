...
int parseblock(const list<string>& lines, int& pos, Prog& prog);
...
int parseblock(const list<string>& lines, int& pos, Prog& prog) {
	prog.cmd.push_back("do");
	// for
	// prog.block.push_back(ln)
	return 0;
}
